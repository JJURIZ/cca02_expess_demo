...
const app = express();
let books = [];
const pageTemplate = '<html><head><title>{{title}}</title></head><body><header><nav><ul><li><a href="/">Home</a></li><li><a href="/newbook">Add A Book</a></li></ul></nav></header><main>{{content}}</main><footer>@copy 2020 JURIZ</footer></body></html>';
